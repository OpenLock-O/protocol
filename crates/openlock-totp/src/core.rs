...
pub use crate::crypto::TotpSecret;
use crate::crypto::{time_step, verify_totp_at_step};
pub use crate::types::{CredentialId, Error, LockId, UnlockRequest, UnlockResponse, Validity};
use crate::types::{ALLOWED_CLOCK_SKEW_STEPS, MAX_ATTEMPTS_PER_STEP};
...
mod tests {
    extern crate std;
    use super::*;
    use crate::crypto::unlock_request;
    use std::cell::Cell;
    use std::rc::Rc;
