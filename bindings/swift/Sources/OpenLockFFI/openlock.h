...
#define OPENLOCK_MAX_EVENT_SIZE 4160
 ...
 * Events may exceed the wire packet limit; use OPENLOCK_MAX_EVENT_SIZE or query
 * the required size with NULL/0 before draining. */
